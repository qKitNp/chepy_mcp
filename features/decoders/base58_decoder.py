...
if __name__ == "__main__":
    # Test with a simple base58 encoded string
    test_string = "9WzcrJc4dMQ79lyWRqeQFa"  # "Hello World" in base58
    try:
        # Decode as string (default)
        decoded_str = decode_base58_chepy(test_string)
        print(f"Encoded: {test_string}")
        print(f"Decoded as string: {decoded_str}")

        # Decode as bytes
        decoded_bytes = decode_base58_chepy(test_string, as_string=False)
        print(f"Decoded as bytes: {decoded_bytes}")

        # Test with another example
        test_string2 = "7DdiPPYtxmfKG57j"  # "This is a test" in base58
        decoded_str2 = decode_base58_chepy(test_string2)
