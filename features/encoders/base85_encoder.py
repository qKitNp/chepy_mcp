...
def demo_encode_decode():
    """
    Demonstrate how to use the encoder with the decoder from base85_decoder.py
    """
    try:
        ...
        print("🔄 Demonstrating base85 encode/decode round-trip:")
        print("=" * 50)
        ...
        # Encode
        encoded = encode_base85_chepy(test_string)
        print(f"Encoded:  {encoded}")

        # Decode back
        decoded = decode_base85_chepy(encoded)
        ...
        print(
            "⚠️  base85_decoder.py not found. Please ensure it exists in the features directory."
        )
    except Exception as e:
        print(f"❌ Error: {e}")
